...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-[400px] md:h-[400px] flex items-center justify-center text-white text-center px-6 overflow-hidden">
      ...
      <div className="relative z-10">
        <h1 className="text-3xl md:text-5xl font-bold">Welcome to Carbon Institute of Paramedical Science</h1>
